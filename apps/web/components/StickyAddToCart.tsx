...
export const StickyAddToCart: React.FC<StickyAddToCartProps> = ({
  ...
  return (
    <div className="md:hidden fixed bottom-[65px] left-0 right-0 z-20 bg-white border-t border-[#E8E2D6] gap-1 px-3 py-3 flex items-center justify-between shadow-lg">
      ...
      <button
        onClick={onAddToCart}
        disabled={!inStock}
        className="flex items-center gap-2 bg-[#7e9677] hover:bg-[#92b089] disabled:bg-[#E8E2D6] disabled:text-[#A89B8A] text-white font-extrabold text-xs py-2 px-3 rounded-lg transition-all shadow-lg shadow-[#7e9677]/25 flex-shrink-0"
      >
