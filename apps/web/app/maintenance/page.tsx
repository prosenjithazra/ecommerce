...
export default function MaintenancePage() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-6 text-center bg-[#FDFAF6] relative overflow-hidden select-none">
      {/* Background blobs */}
      <div className="absolute -top-20 -right-20 w-72 h-72 bg-[#7e9677]/10 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '6s' }} />
      <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-[#df794d]/10 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '8s' }} />
      ...
      <div className="max-w-lg w-full space-y-4 sm:space-y-6 relative z-10">
        ...
        <div className="relative flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 mx-auto">
          {/* Outer Gear */}
          <Settings 
            className="w-12 h-12 sm:w-16 sm:h-16 text-[#df794d] animate-spin" 
            style={{ animationDuration: '8s' }} 
          />
          {/* Inner Gear */}
          <Settings 
            className="w-8 h-8 sm:w-10 sm:h-10 text-[#7e9677] absolute top-1.5 right-1.5 sm:top-2 sm:right-2 animate-spin-reverse" 
        ...
        <div className="space-y-2">
          <h1 className="text-2xl sm:text-4xl font-black tracking-tight text-[#4A453E] leading-none">
            Tuning Our <span className="text-[#7e9677]">Printing Presses</span>
          </h1>
        ...
        <div className="max-w-sm mx-auto bg-white border border-[#E8E2D6] rounded-xl p-3.5 sm:p-4 shadow-sm text-left space-y-2 sm:space-y-3">
          <div className="flex items-start gap-2">
            <ShieldCheck className="w-3.5 h-3.5 text-[#7e9677] mt-0.5 flex-shrink-0" />
            <div>
