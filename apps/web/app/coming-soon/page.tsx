...
export default function ComingSoonPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-6 text-center bg-[#FDFAF6] relative overflow-hidden select-none">
      {/* Background blobs */}
      <div className="absolute -top-20 -left-20 w-72 h-72 bg-[#df794d]/10 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '5s' }} />
      <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-[#7e9677]/10 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '7s' }} />
      ...
      <div className="max-w-lg w-full space-y-3 md:space-y-8 relative z-10">
        ...
        <div className="flex flex-col items-center justify-center space-y-3">
          ...
          <div className="flex items-center gap-1 bg-[#df794d]/15 border border-[#df794d]/30 rounded-full px-3 py-1 text-[9px] font-black text-[#E8855A] tracking-widest uppercase">
        ...
        <div className="space-y-3">
          <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-[#4A453E] leading-1">
            Our Premium Storefront is <span className="text-[#df794d] block">Coming Soon</span>
          </h1>
        ...
        <form onSubmit={handleSubmit} className="relative max-w-sm mx-auto">
          <div className="relative">
            <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-[#7e9677]" />
            <input
              required
              type="email"
              value={email}
              ...
              className="w-full bg-white border border-[#E8E2D6] focus:border-[#df794d] rounded-lg py-3.5 pl-11 pr-28 text-xs font-semibold text-[#4A453E] outline-none transition-all shadow-sm"
              disabled={loading}
            />
            <button
              type="submit"
              disabled={loading}
              className="absolute right-1.5 top-1/2 -translate-y-1/2 bg-[#df794d] hover:bg-[#E8855A] text-white text-[10px] font-extrabold py-2 px-4 rounded-md transition-all flex items-center gap-1 disabled:opacity-50"
            >
        ...
        <div className="pt-6 border-t border-[#E8E2D6] flex flex-col items-center gap-4">
          ...
          <div className="flex gap-4">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-white border border-[#E8E2D6] text-[#7A736A] hover:text-[#df794d] hover:border-[#df794d] transition-all shadow-sm" aria-label="Facebook">
              <FacebookIcon className="w-4 h-4" />
            </a>
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-white border border-[#E8E2D6] text-[#7A736A] hover:text-[#df794d] hover:border-[#df794d] transition-all shadow-sm" aria-label="YouTube">
              <YoutubeIcon className="w-4 h-4" />
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full bg-white border border-[#E8E2D6] text-[#7A736A] hover:text-[#df794d] hover:border-[#df794d] transition-all shadow-sm" aria-label="Instagram">
