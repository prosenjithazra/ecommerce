...
export default function ResetPasswordPage() {
  ...
  const inputClass = "mt-1.5 w-full bg-[#FDFAF6] border border-[#E8E2D6] rounded-lg py-3 px-4 text-xs outline-none focus:border-[#df794d] text-[#4A453E] placeholder-[#A89B8A]";
